...
==> Installing grep
==> Downloading https://homebrew.bintray.com/bottles/grep-3.3.mojave.bottle.1.tar.gz
######################################################################## 100.0%
==> Pouring grep-3.3.mojave.bottle.1.tar.gz
==> Caveats
...
==> Summary
🍺  /usr/local/Cellar/grep/3.3: 21 files, 884.8KB
==> Caveats
==> grep
All commands have been installed with the prefix "g".
If you need to use these commands with their normal names, you
